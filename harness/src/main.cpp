/*
 * EmbeddPilot V1 — Reference I2C Driver for ESP32 + BMP180
 *
 * This is the KNOWN-GOOD reference driver. It is hand-written against the
 * ESP32 TRM and BMP180 datasheet to serve as ground truth for the
 * verification harness. The AI-generated driver must produce identical
 * functional behavior to pass.
 *
...
// Test 2: Read chip ID — must return 0x55
...
// Test 3: Write measurement command and verify I2C write succeeds
...
// Test 4: Burst read of measurement data
...
// Test 5: Soft reset and verify chip responds after reset
